...
my %sources = ( 
    js => { defmin => [ qw( scripts/default.js skins/default/scripts/default.js ) ],
            defcontmin => [ qw( scripts/default.js skins/default/scripts/default.js skins/default/scripts/create_menu_expander.js skins/default/scripts/create_menu_setup.js) ],
    },
    css => { defmin => [qw(stylesheets/reset.css stylesheets/default.css skins/default/stylesheets/default.css) ],
             defcontmin => [qw(stylesheets/reset.css stylesheets/default.css skins/default/stylesheets/default.css skins/default/stylesheets/create_menu_style.css) ],
    }
); 

			...
			<body>
				...
				<div id="content-container">
					<form action="{$xims_box}{$goxims_content}" method="get">
                        ...
                        &#160;
                        <input type="button" class="ui-state-default ui-corner-all fg-button" name="default" onclick="javascript:history.go(-1)"><xsl:attribute name="value"><xsl:value-of select="$i18n/l/cancel"/></xsl:attribute></input>
						</div>
					</form>
				</div>
			</body>

...
XIMS::Exporter::VLibraryItem::NewsItem
...
=head1 SYNOPSIS
    ...
    use XIMS::Exporter::VLibraryItem::NewsItem;

=head1 DESCRIPTION

Exporter subclass for VLibraryItem::NewsItems.

=head1 SUBROUTINES/METHODS

=cut

package XIMS::Exporter::VLibraryItem::NewsItem;

use common::sense;
use XIMS::Exporter;
use parent qw( XIMS::Exporter::NewsItem2 );
use XIMS::ObjectType;
use XIMS::ObjectPriv;
...
sub create {
    ...
    if ( @children and scalar @children ) {
        ...
        foreach my $kind (@children) {
            ...
            # but don't automatically publish NewsItemLinks

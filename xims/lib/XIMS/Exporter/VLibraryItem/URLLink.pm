...
XIMS::Exporter::VLibraryItem::URLLink -- A .... doing bla, bla, bla. (short)
...
=head1 SYNOPSIS
    ...
    use XIMS::Exporter::VLibraryItem::URLLink;
...
package XIMS::Exporter::VLibraryItem::URLLink;

use common::sense;
use XIMS::Exporter;
use parent -norequire, qw( XIMS::Exporter::URLLink );
use XIMS::ObjectType;
use XIMS::ObjectPriv;

...
XIMS::Exporter::VLibraryItem::DocBookXML -- A .... doing bla, bla, bla. (short)
...
=head1 SYNOPSIS
    ...
    use XIMS::Exporter::VLibraryItem::DocBookXML;
...
use common::sense;
use XIMS::Exporter;
use parent -norequire, qw( XIMS::Exporter::sDocBookXML );
use XIMS::ObjectType;
use XIMS::ObjectPriv;

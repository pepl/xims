...
Class::XSAccessor::Compat provides get/set accessor methods for all the content object
...
by Class::XSAccessor::Compat to avoid the memory/performance hit of loading the content

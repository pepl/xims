...
XIMS::SimpleDBMember -- A .... doing bla, bla, bla. (short)
...
=head2    my $member = XIMS::SimpleDBMember->new( [ %args ] );
...
Fetches existing mappings or creates a new instance of XIMS::SimpleDBMember.

...
ok( $authmap );
is( $authmap->reference_id(), $reference->id(), 'TestAuthorMap has correct reference id' );
...
$authmap = undef;
$authmap = XIMS::RefLibAuthorMap->new( reference_id => $reference->id(), author_id => $author->id, role => 0 );

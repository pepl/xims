...
*/
this.buttonDefs = {
            'search': ["Suchen/Ersetzen", "find_replace_popup", this.options.path + "../images/silk/find.png", this.find_replace_popup],
            'searchClose': ["Schlie\u00DFen", "find_replace_popup_close", this.options.path + "../images/silk/cancel.png", this.find_replace_popup_close],
            'searchDialog': ["Suchen/Ersetzen", "find_replace_window", this.options.path + "../images/silk/find.png", this.find_replace_window],
            'undo': ["R\u00FCckg\u00E4ngig", "undo", this.options.path + "../images/silk/arrow_undo.png", this.undo],
            'redo': ["Wiederherstellen", "redo", this.options.path + "../images/silk/arrow_redo.png", this.redo],
            'jump': ["Gehe zu Zeile #", "jump", this.options.path + "../images/silk/page_go.png", this.jump],
            'reindentSelection': ["Auswahl formatieren", "reindentSelect", this.options.path + "../images/silk/text_indent.png", this.reindentSelection],
            'reindent': ["Alles formatieren", "reindent", this.options.path + "../images/silk/page_refresh.png", this.reindent],
            'about': ["\u00FCber CodeMirror-UI", "about", this.options.path + "../images/silk/help.png", this.about]
	/* uibk */
//'cancel': ["Schlie\u00DFen", "close", this.options.path + imgPath + "cancel.png", this.toTextArea]
			//			/* end uibk */
        };
  ...
  createFindBar: function() {
    ...
    regLabel.title = "Regul\u00E4rer Ausdruck";
    ...
    this.replaceButton.value = "Ersetzen";
    ...
    replaceAllLabel.title = "Alle Ersetzen";
    ...
    //replaceAllLabel.appendChild(document.createTextNode("All"));
     replaceAllLabel.appendChild(document.createTextNode("Alle"));
  ...
  find: function( start ) {
    ...
    if (findString == null || findString == '') {
      ...
      alert("Geben Sie einen Suchbegrif ein.");
      return;
    }
    ...
    if (found) {
      ...
      if (confirm("Keine weiterern Treffer. Von vorne beginnen?")) {

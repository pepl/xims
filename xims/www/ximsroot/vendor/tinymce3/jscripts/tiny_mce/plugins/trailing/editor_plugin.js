 ...
 * http://www.enonic.com
 *
 * Author: Mariusz Pekala (Arsen7) <skoot@qi.pl>
 */
...
//alert('test');
                        ...
                        try {
                                ...
                                /*if( fc.nodeType == 1 && needsSpace(fc.nodeName.toLowerCase()) && (!fc.innerHTML.match(/^(\s|<br\s*\/?>|&nbsp;)*$/i) || !fc.firstChild) ) {
				...
				_needsSpace: function(noide){
//alert('test');
					switch(node){
						case 'p': return false;
						case 'h1': return false;
						case 'h2': return false;
						case 'h3': return false;
						case 'h4': return false;
						case 'h5': return false;
						case 'h6': return false;
						default : alert("true");return true;
					}
				}
        });

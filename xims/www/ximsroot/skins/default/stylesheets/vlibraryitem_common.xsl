...
<xsl:template name="tr-vlauthors-create">
    <tr>
        <td valign="top"><xsl:value-of select="$i18n_vlib/l/Assign_new"/><xsl:text>&#160;</xsl:text><xsl:value-of select="$i18n/l/Author"/></td>
        <td colspan="2">
...
<xsl:template name="tr-date-create">
    <tr>
        ...
        <td colspan="2">
            von <input tabindex="20" type="text" name="date_from" size="10" class="text" maxlength="10"/> (JJJJ-MM-TT) <img 
                src="{$ximsroot}jscalendar-1.0/img.gif" id="f_trigger_c"
        ...
        <script type="text/javascript">
            ...
            bis <input tabindex="20" type="text" name="date_to" size="10" class="text" maxlength="10"/> (JJJJ-MM-TT)
            <xsl:text>&#160;</xsl:text>
...
<xsl:template name="tr-date-edit">
    ...
    <tr>
        ...
        <td colspan="2">
            <input tabindex="20" type="text" name="date" size="10" class="text" maxlength="10" value="{$date_from}" /> (JJJJ-MM-TT)
            <xsl:text>&#160;</xsl:text>
<!--            <a href="javascript:openDocWindow('Date')" class="doclink">(?)</a> -->
        </td>
    </tr>

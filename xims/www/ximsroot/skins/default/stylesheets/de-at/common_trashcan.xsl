...
# $Id: common_trashcan.xsl 2188 2009-01-03 18:24:00Z pepl $
-->
        ...
        <html>
            ...
            <body margintop="0" marginleft="0" marginwidth="0" marginheight="0" background="{$skimages}body_bg.png">
                <xsl:call-template name="header">
                    <xsl:with-param name="nooptions">wahr</xsl:with-param>
                    <xsl:with-param name="nostatus">wahr</xsl:with-param>
                </xsl:call-template>

...
<xsl:template match="/document">
    <html>
        ...
        <div align="center">
            <p>
                <a href="{$xims_box}{$goxims_users}?create=1">Neuen User erstellen</a>
            </p>
        </div>
...
<xsl:template name="options">
   ...
   <tr>
   <td><a href="{$xims_box}{$goxims_users}?edit=1;name={name}">User bearbeiten</a></td>
   <td><a href="{$xims_box}{$goxims_users}?passwd=1;name={name}">Passwort ändern</a></td>
   <td><a href="{$xims_box}{$goxims_users}?remove=1;name={name}">User löschen</a></td>

            ...
            <td background="{$skimages}generic_tablebg_1x20.png">
              <xsl:choose>
                <xsl:when test="$sort-by='lastname'">
                  <a href="{$xims_box}{$goxims_users}?sort-by=lastname;order-by={$order-by-opposite}">ganzer Name</a>
                </xsl:when>
                <xsl:otherwise>
                  <a href="{$xims_box}{$goxims_users}?sort-by=lastname;order-by={$order-by}">ganzer Name</a>
                </xsl:otherwise>
              </xsl:choose>
            </td>
            <td background="{$skimages}generic_tablebg_1x20.png">
              <xsl:choose>
                <xsl:when test="$sort-by='system_privs_mask'">
                  <a href="{$xims_box}{$goxims_users}?sort-by=system_privs_mask;order-by={$order-by-opposite}">System Privil.</a>
                </xsl:when>
                <xsl:otherwise>
                  <a href="{$xims_box}{$goxims_users}?sort-by=system_privs_mask;order-by={$order-by}">System Privil.</a>
                </xsl:otherwise>
              </xsl:choose>
            </td>
            <td background="{$skimages}generic_tablebg_1x20.png">
            ...
            <td background="{$skimages}generic_tablebg_1x20.png">
              <xsl:choose>
                <xsl:when test="$sort-by='enabled'">
                  <a href="{$xims_box}{$goxims_users}?sort-by=enabled;order-by={$order-by-opposite}">Benutzer Status</a>
                </xsl:when>
                <xsl:otherwise>
                  <a href="{$xims_box}{$goxims_users}?sort-by=enabled;order-by={$order-by}">Benutzer Status</a>
                </xsl:otherwise>
              </xsl:choose>
            </td>
            <td background="{$ximsroot}images/dyn04_dark.jpg" width="250">
              <img src="{$ximsroot}images/options.png" width="180" height="21" alt="optionen"/>
            </td>
          </tr>

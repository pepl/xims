...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/document/context/object">
        <html>
            <head>
                <title>Create new XSL-Stylesheet in <xsl:value-of select="$absolute_path"/> - XIMS</title>
            ...
            <body onLoad="document.eform.body.value='';document.eform.abstract.value='';document.eform.name.focus()">
                ...
                <p class="edit">
                    <table border="0" align="center" width="98%">
                        <tr>
                            <td>Create new XSL-Stylesheet in <xsl:value-of select="$absolute_path"/></td>
                    ...
                    <form action="{$xims_box}{$goxims_content}{$absolute_path}?objtype=XSLStylesheet" name="eform" method="POST">
                        <input type="hidden" name="objtype" value="XSLStylesheet"/>

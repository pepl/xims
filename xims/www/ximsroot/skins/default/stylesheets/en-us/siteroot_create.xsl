...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/TR/xhtml1/strict">
    ...
    <xsl:template match="/document/context/object">
        <html>
            <head>
                <title>Create new SiteRoot in <xsl:value-of select="$absolute_path"/> - XIMS</title>
            ...
            <body onLoad="document.eform.name.focus()">
                ...
                <p class="edit">
                    <table border="0" align="center" width="98%">
                        <tr>
                            <td>Create new SiteRoot in <xsl:value-of select="$absolute_path"/></td>
                    ...
                    <form action="{$xims_box}{$goxims_content}{$absolute_path}?objtype=SiteRoot" name="eform" method="POST">
                        <input type="hidden" name="objtype" value="SiteRoot"/>

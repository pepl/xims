...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/TR/xhtml1/strict">
    ...
    <xsl:template match="/document/context/object">
        <html>
            <head>
                <title>Edit Image '<xsl:value-of select="title"/>' in <xsl:value-of select="$parent_path"/> - XIMS</title>
            ...
            <body>
                ...
                <p class="edit">
                    <table border="0" align="center" width="98%">
                        <tr>
                            <td>Edit Image '<xsl:value-of select="title"/>' in <xsl:value-of select="$parent_path"/></td>

...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/document/context/object">
        <html>
            <head>
                <title>Position object in '<xsl:value-of select="parents/object[@id=/document/context/object/@parent_id]/title"/>' - XIMS</title>
            ...
            <body>
                ...
                <form name="repos">
                    <table cellpadding="10">
                        <tr>
                            <td valign="top">
                                Select a new position for object <br/>'<xsl:value-of select="title"/>' in <br/> 

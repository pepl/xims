...
<xsl:stylesheet version="1.0"
    ...
    <xsl:output method="xml" encoding="iso-8859-1" media-type="text/html" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd" doctype-public="-//W3C//DTD XHTML 1.0 Transitional//EN" indent="no"/>
        ...
        <html>
            <head>
                <title>Create new AxPointPresentation in <xsl:value-of select="$absolute_path"/> - XIMS</title>
            ...
            <body onLoad="document.eform.body.value='';document.eform.abstract.value='';document.eform.name.focus()">
                ...
                <p class="edit">
                    <table border="0" align="center" width="98%">
                        <tr>
                            <td>Create new AxPointPresentation in <xsl:value-of select="$absolute_path"/></td>
                    ...
                    <form action="{$xims_box}{$goxims_content}{$absolute_path}?objtype=AxPointPresentation" name="eform" method="POST">
                        <input type="hidden" name="objtype" value="AxPointPresentation"/>

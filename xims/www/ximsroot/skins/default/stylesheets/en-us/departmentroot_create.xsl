...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/document/context/object">
        <html>
            <head>
                <title>Create new DepartmentRoot in <xsl:value-of select="$absolute_path"/> - XIMS</title>
            ...
            <body>
                ...
                <p class="edit">
                    <table border="0" align="center" width="98%">
                        <tr>
                            <td>Create new DepartmentRoot in <xsl:value-of select="$absolute_path"/></td>
                    ...
                    <form action="{$xims_box}{$goxims_content}{$absolute_path}?objtype=DepartmentRoot" name="eform" method="POST">
                        <input type="hidden" name="objtype" value="DepartmentRoot"/>

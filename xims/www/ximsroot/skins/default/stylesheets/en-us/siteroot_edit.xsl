...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/document/context/object">
        <html>
            <head>
                <title>Edit SiteRoot '<xsl:value-of select="title"/>' in <xsl:value-of select="$parent_path"/> - XIMS</title>
            ...
            <body>
                ...
                <p class="edit">
                    <table border="0" align="center" width="98%">
                        <tr>
                            <td>Edit SiteRoot '<xsl:value-of select="title"/>' in <xsl:value-of select="$parent_path"/></td>
        ...
        <tr>
            ...
            <td>
                <a href="{$goxims_content}{$absolute_path}?portlet_id={id};rem_portlet=1">
                    <img src="{$ximsroot}images/option_delete.png"
                        border="0"
                        width="37"
                        height="19"
                        alt="Delete Portlet"

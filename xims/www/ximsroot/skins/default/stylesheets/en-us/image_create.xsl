...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/TR/xhtml1/strict">
    ...
    <xsl:template match="/document/context/object">
        <html>
            <head>
                <title>Create new Image in <xsl:value-of select="$absolute_path"/> - XIMS</title>
            ...
            <body onLoad="document.eform.abstract.value=''">
                ...
                <p class="edit">
                    <table border="0" align="center" width="98%">
                        <tr>
                            <td>Create new Image in <xsl:value-of select="$absolute_path"/>
                            </td>
                    ...
                    <form action="{$xims_box}{$goxims_content}{$absolute_path}?objtype=Image" method="POST" enctype="multipart/form-data" name="eform">
                        <input type="hidden" name="objtype" value="Image"/>
                        <table border="0" width="95%">
                            ...
                            <tr>
                                <td valign="top">
                                    <span class="compulsory">Image</span>
                                </td>
                                <td>

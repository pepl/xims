                                ...
                                <tr>
                                    <td>
                                        <xsl:if test="$searchstring != ''">
                                            ...
                                            <xsl:if test="$searchstring != ''">
                                                <span class="simpledb_filter">'<xsl:value-of select="$searchstring"/>'</span></xsl:if>.
        ...
        <table align="center" cellpadding="5" style="border: 1px dotted black; margin-bottom: 5px;">
            <tr>
                <td style="border: 1px dotted black;">
                    <xsl:if test="$m='e' and /document/context/object/user_privileges/create and /document/member_properties/member_property[1]">
                        ...
                        <div class="simpledb_access_xmlimport">
                            <a target="_new">
                                <xsl:attribute name="href">
                                    <xsl:choose>
                                        <xsl:when test="$searchstring != ''"><xsl:value-of select="concat('?searchstring=',$searchstring,';')"/></xsl:when>

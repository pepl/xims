...
/*	//custom IE 9 detection because of Bug when pressing Enter
  ...
  //select.ie_selection = document.selection && document.selection.createRangeCollection && !(isIE9StdMode());
  //select.ie_selection = document.selection && document.selection.createRangeCollection && /MSIE\s+[4-8]\b/;
  //select.ie_selection = document.selection && window.ActiveXObject && /MSIE/.test(navigator.userAgent) && /MSIE\s+[4-8]\b/;
  select.ie_selection = !(window.getSelection && document.createRange && document.createRange().endContainer);
  //select.ie_selection = !(window.getSelection && document.createRange && document.createRange().endContainer && /MSIE\s+[4-8]\b/);
  ...
  // W3C model
    ...
    select.insertNodeAtCursor = function(node) {
	  ...
	  //webkit and gecko newline issues
      webkitLastLineHack(document.body);
	  geckoLastLineHack(document.body);

...
<xsl:template name="tr-target-create">
    <tr>
        ...
        <td colspan="2">
            ...
            <xsl:text>&#160;</xsl:text>
            <a href="javascript:genericWindow('{$xims_box}{$goxims_content}{$absolute_path}?contentbrowse=1;otfilter=Folder,DepartmentRoot,SiteRoot;sbfield=eform.target')" class="doclink"><xsl:value-of select="$i18n/l/browse_target"/></a>
        </td>
    </tr>
</xsl:template>
</xsl:stylesheet>

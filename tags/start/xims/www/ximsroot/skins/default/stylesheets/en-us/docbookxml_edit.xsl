            ...
            <body>
                ...
                <p class="edit">
                    <table border="0" align="center" width="98%">
                        <tr>
                            <td>Edit sDocBookXML '<xsl:value-of select="title"/>' in <xsl:value-of select="$parent_path"/></td>
                    ...
                    <form action="{$xims_box}{$goxims_content}{$absolute_path}" method="POST" name="eform">
                        <table border="0" width="95%">
                            <tr>
                                ...
                                <td>
                                    <input tabindex="1" type="text" class="text" name="name" size="40" value="{substring-before(location, concat('.', /document/data_formats/data_format[@id = /document/data_formats/data_format]/suffix))}"/>
                                    <xsl:text>&#160;</xsl:text>

...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/document/context/object">
        <html>
            <head>
                <title>Edit XSL-Stylesheet '<xsl:value-of select="title"/>' in <xsl:value-of select="$parent_path"/> - XIMS</title>
            ...
            <body>
                ...
                <p class="edit">
                    <table border="0" align="center" width="98%">
                        <tr>
                            <td>Edit XSL-Stylesheet '<xsl:value-of select="title"/>' in <xsl:value-of select="$absolute_path"/></td>

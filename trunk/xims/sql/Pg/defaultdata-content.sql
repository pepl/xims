...
INSERT INTO ci_content ( id, document_id, title, language_id, last_modified_by_id, owned_by_id, created_by_id, data_format_name )
       VALUES (nextval('ci_content_id_seq'), 2, '/ximspubroot/xims', 2, 2, 2, 2, 'SiteRoot');

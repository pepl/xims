...
INSERT INTO CI_LANGUAGES ( id, fullname, code ) VALUES ( LNG_SEQ.NEXTVAL, 'Deutsch (�sterreich)', 'de-at' );
...
INSERT INTO CI_OBJECT_TYPES ( id, name, is_fs_container, is_xims_data, redir_to_self, parent_id, menu_level ) VALUES ( OBT_SEQ.NEXTVAL, 'NewsItem', 0, 1, 1, (SELECT id FROM CI_OBJECT_TYPES WHERE name = 'VLibraryItem' ), 0 );
...
INSERT INTO CI_OBJECT_TYPES ( id, name, is_fs_container, is_xims_data, redir_to_self, publish_gopublic, is_mailable, menu_level, is_davgetable, davprivval ) VALUES ( OBT_SEQ.NEXTVAL, 'Markdown', 0, 1, 1, 0, 1, 2, 1, 2 );
...
INSERT INTO CI_DATA_FORMATS ( id, name, mime_type, suffix ) VALUES ( DFM_SEQ.NEXTVAL, 'Markdown', 'text/x-markdown', 'md' );

...
sub event_import {
    ...
    ssn => [ "" ],
    quarter => [ "" ],
    volume => [ "m:relatedItem[\@type='host']/m:part/m:detail[\@type='volume']/m:number"],
    part => [ "m:relatedItem[\@type='host']/m:part/m:detail[\@type='part']/m:title"],
    issue => [ "m:relatedItem[\@type='host']/m:part/m:detail[\@type='issue']/m:number" ],
    spage => [ "m:relatedItem[\@type='host']/m:part/m:extent[\@unit='page']/m:start|m:relatedItem[\@type='host']/m:part/m:detail[\@type='page']/m:number", sub { my $v = $_[0]->textContent(); $v =~ /^(\d+)\-?/; return $1 } ],
    epage => [ "m:relatedItem[\@type='host']/m:part/m:extent[\@unit='page']/m:end|m:relatedItem[\@type='host']/m:part/m:detail[\@type='page']/m:number", sub { my $v = $_[0]->textContent(); $v =~ /\-?(\d+)$/; return $1 } ],
    pages => [ "" ],
    artnum => [ "" ],

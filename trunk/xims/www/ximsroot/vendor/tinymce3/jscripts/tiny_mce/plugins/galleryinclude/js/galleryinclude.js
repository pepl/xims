/* Functions for the galleryinclude plugin popup */
...
function init() {
	...
	//prefill form when inserting new element
		...
		{
			setFormValue("linktitle", "-[Bildergalerie]-");
		}

...
# $Id: vlibrary_publications.xsl 2203 2009-04-29 10:46:36Z haensel $
-->
...
<xsl:stylesheet version="1.0"
    ...
    <xsl:import href="vlibrary_default.xsl"/>
		...
		<xsl:param name="mo" select="'publication'"/>
 ...
 <xsl:call-template name="vlpropertyinfo">
			<xsl:with-param name="sortedproperties" select="$sortedpublications"/>
			<xsl:with-param name="unmappedproperties" select="$unmappedpublications"/>

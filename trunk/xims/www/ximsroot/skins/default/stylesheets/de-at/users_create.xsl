...
<xsl:template match="/document">
    <html>
        <head>
            <title>
                Neuen System User erstellen - XIMS
            </title>
        ...
        <table width="99%" cellpadding="0" cellspacing="0" border="0" bgcolor="#eeeeee">
          ...
          <tr>
            ...
            <tr><td><br/></td></tr>
              <tr>
                <td align="center" class="bluebg" colspan="2">User erstellen</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                    <img src="{$ximsroot}images/spacer_white.gif" alt="*"/>
                    <span class="compulsory">Nachname:</span>
                </td>

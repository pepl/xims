...
<xsl:template name="scripts">
    <script type="text/javascript">
      <![CDATA[
        function insertfile(editor) {
          if (document.selectform.imgpath.value.length > 0){
            createImage(editor, document.selectform.imgpath.value, document.selectform.imgtext.value);
          }
          window.close();
        }
      ...
      <![CDATA[
        ...
        function createImage (editor, path, title) {
            var img;
            if ( editor.is_ie ) {
    ...
    <!-- TODO: Strings should be added to i18n.xml and $lang/common_contentbrowse*.xsl obsoleted -->
    <xsl:template name="selectform">
        <form action="{$xims_box}{$goxims_content}" method="POST" name="selectform" id="selectform">
            <table>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="imgpath" size="40"/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="imgtext" size="40"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <input class="control" type="button" value="Store Back" onClick="insertfile(window.opener.xinha_editors.body);"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">

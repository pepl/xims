			...
			<body>
				...
				<div id="content-container">
					<form action="{$xims_box}{$goxims_content}" method="get">
						...
						<p>
                        Klicken Sie auf 'Bestätigen' um fortzufahren, oder auf 'Abbrechen' um zur vorigen Seite zu gelangen.
                    </p>
						<div id="confirm-buttons">
							<input class="ui-state-default ui-corner-all fg-button" name="trashcan" type="submit" value="Bestätigen"/>

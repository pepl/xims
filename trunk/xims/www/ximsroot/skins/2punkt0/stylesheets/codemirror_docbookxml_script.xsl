<?xml version="1.0"?>
	<!--
		...
		$Id: codemirror_docbookxml_script.xsl 2249 2009-08-10 11:29:26Z haensel $
	-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <xsl:template name="codemirror_scripts">
		...
		<xsl:call-template name="codemirror_docbookxml_init" />
	</xsl:template>
    
	<xsl:template name="codemirror_docbookxml_init">

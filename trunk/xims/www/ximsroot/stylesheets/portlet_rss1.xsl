...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="portlet-item" mode="seq">
        <rdf:li xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" rdf:resource="http://xims.info{location_path}"/>
    </xsl:template>

    <xsl:template match="portlet-item" mode="item">
        <item xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" rdf:about="http://xims.info{location_path}">
            <title>
                <xsl:value-of select="title"/>
            </title>
            <link>http://xims.info<xsl:value-of select="location_path"/>
            </link>

...
XIMS::RefLibReferencePropertyMap -- A .... doing bla, bla, bla. (short)
...
=head1 SYNOPSIS
    ...
    use XIMS::RefLibReferencePropertyMap;
...
=head2    my $propertymap = XIMS::RefLibReferencePropertyMap->new( [ %args ] );

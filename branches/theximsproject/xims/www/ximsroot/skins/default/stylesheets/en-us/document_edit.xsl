            ...
            <head>
                ...
                <script type="text/javascript">
                    ...
                    function openTestWFWindow() {
                        ...
                        testwfwindow.document.writeln('<\/head><body>');
                        ...
                        testwfwindow.document.writeln("<\/form>");
                        testwfwindow.document.writeln("<\/body><\/html>");
//                        testwfwindow.document.forms['the_form'].submit();
//                        testwfwindow.document.forms[0].submit();                    
                    }
                    ]]>
                </script>
            ...
            <body>
                ...
                <p class="edit">
                    ...
                    <form action="{$xims_box}{$goxims_content}{$absolute_path}" method="POST" name="eform" style="margin-top:0px; margin-bottom:5px; margin-left:0px; margin-right:0px;">
                        <table border="0" width="95%" style="background-color:#ced3d6;">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <br/>
                                    <textarea tabindex="3" name="body" rows="15" cols="90" style="font-family: 'Courier New','Verdana'; font-size: 10pt; border:#333333 solid 1px;">
                                        <xsl:choose>

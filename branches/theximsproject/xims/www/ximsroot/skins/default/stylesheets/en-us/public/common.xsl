...
<xsl:template name="stdlinks">
    <p class="stdlinks">
        <a href="http://xims.sf.net/">The Xims Project</a><br />
        <a href="http://www.axkit.org/">AxKit</a><br />
        <!--<a href="{$request.uri}?style=print">-->Druckansicht<!--</a>--><br />
        <!--><a href="{$request.uri}?style=textonly">-->Nur Text<!--</a>--><br />
   </p>
</xsl:template>
...
<xsl:template name="copyfooter">
    <p class="copy">
          © 2000 - 2012 Example Org. - All rights reserved <br /><a href="http://www.vatican.va/">Help</a> | <a href="mailto:webmaster@doesnot.exist">Mail the webmaster</a>
    </p>
</xsl:template>

...
# $Id: document_create_htmlarea.xsl 2188 2009-01-03 18:24:00Z pepl $
-->
...
<html>
    ...
    <body onload="timeoutWYSIWYGChange(2); document.eform['abstract'].value=''; initEditor(); document.eform.name.focus();">
        <div class="edit">
